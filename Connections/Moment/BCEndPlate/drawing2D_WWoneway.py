...
class OnewayEndPlate_WW(object):
    ...
    def draw_dimension_inner_arrow(self, dwg, pt_a, pt_b, text, params):
		...
		Args:
			...
			text: text message
			params:
				params["offset"] (float):n is_list_of_offset of the dimension line
				params["textoffset"] (flon is_list_of_t): offset of text from dimension line
				params["lineori"] (float)n is_list_of_ orientation of line [right/left]
				params["endlinedim"] (flon is_list_of_t): dimension line at the end of the outer arrow
				params["arrowlen"] (floatn is_list_of_: size of the arrow
