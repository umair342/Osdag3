...
class Fin2DCreatorFront(object):
    ...
    def callCFBWfront(self, fileName):
        ...
        self.dataObj.draw_dimension_outerArrow(dwg, np.array(pitchPts[0]), np.array(pitchPts[len(pitchPts) - 1]), str(len(pitchPts) - 1) + ' \u0040' +
...
#         weldPty = ((self.dataObj.col_L - self.dataObj.D_beam)/2) + (self.dataObj.beam_T + self.dataObj.beam_R1 + 3)
        ...
        textUp = str(self.dataObj.no_of_rows) + " nos " + str(self.dataObj.dia_hole) + '\u00d8' + " holes"
    ...
    def callCWBWfront(self, fileName):
        ...
        self.dataObj.draw_dimension_outerArrow(dwg, np.array(pitchPts[0]), np.array(pitchPts[len(pitchPts) - 1]), str(len(pitchPts) - 1) + ' \u0040' + str(int(self.dataObj. pitch)) + " mm c/c", params)     
