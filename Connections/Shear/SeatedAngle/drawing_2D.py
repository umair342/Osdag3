...
class Seat2DCreatorFront(object):
    ...
    def call_CFBF_front(self, file_name):
        ...
        text_up = str(no_of_bolts_beam) + " nos " + str(self.data_object.bolt_hole_diameter) + '\u00d8' + " holes"
        ...
        text_up = str(no_of_bolts_column) + " nos " + str(self.data_object.bolt_hole_diameter) + '\u00d8' + " holes"
    ...
    def call_CWBF_front(self, file_name):
        ...
        text_up = str(no_of_bolts) + "nos " + str(int(self.data_object.bolt_hole_diameter)) + '\u00d8' + "holes "
