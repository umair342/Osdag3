    ...
    def save_to_svg(self, filename, view):
        ...
        if self.connectivity == 'Column flange-Beam web':
            if view == "Front":
                ...
                fin_2d_front.call_CFBW_front(filename)
                cairosvg.svg2png(file_obj=open(filename,'rb'), write_to=os.path.join(str(self.folder), "images_html", "cleatFront.png"))

                filename = os.path.join(str(self.folder), "images_html", "cleatSide.svg")
                fin_2d_side.call_CFBW_side(filename)
                cairosvg.svg2png(file_obj=open(filename,'rb'), write_to=os.path.join(str(self.folder), "images_html", "cleatSide.png"))


                filename = os.path.join(str(self.folder), "images_html", "cleatTop.svg")
                fin_2d_top.call_CFBW_top(filename)
                cairosvg.svg2png(file_obj=open(filename,'rb'), write_to=os.path.join(str(self.folder), "images_html", "cleatTop.png"))
