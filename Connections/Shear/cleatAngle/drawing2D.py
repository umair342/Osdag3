...
class Cleat2DCreatorFront(object):
    ...
    def call_BWBW_front(self, filename):
        ...
        text_up = str(no_of_bolts) + " nos " + str(self.dataObj.dia_hole) + '\u00d8' + " holes"
    ...
    def call_CWBW_front(self, filename):
        ...
        text_up = str(no_of_cbolts) + " nos " + str(self.dataObj.dia_hole) + '\u00d8' + " holes"
...
class Cleat2DCreatorTop(object):
    ...
    def call_BWBW_top(self, filename):
        ...
        text_up = str(self.dataObj.no_of_rows * self.dataObj.no_of_col) + " nos " + str(self.dataObj.dia_hole) + '\u00d8' + " holes"
    ...
    def call_CWBW_top(self, filename):
        ...
        text_up = str(no_of_bbolts) + " nos " + str(self.dataObj.dia_hole) + '\u00d8' + " holes"
