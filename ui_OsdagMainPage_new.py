...
# Form implementation generated from reading ui file 'OsdagMainPage_new.ui'
#
...
"}")
        ...
        self.layoutWidget = QtWidgets.QWidget(self.Tension)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 2, 1141, 830))
        self.layoutWidget.setObjectName("layoutWidget")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        spacerItem19 = QtWidgets.QSpacerItem(150, 828, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem19)
        self.rdbtn_bolted = QtWidgets.QRadioButton(self.layoutWidget)
        ...
        self.rdbtn_bolted.setIconSize(QtCore.QSize(200, 200))
        self.rdbtn_bolted.setObjectName("rdbtn_bolted")
        self.horizontalLayout_2.addWidget(self.rdbtn_bolted)
        spacerItem20 = QtWidgets.QSpacerItem(150, 828, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem20)
        self.rdbtn_welded = QtWidgets.QRadioButton(self.layoutWidget)
        ...
        self.rdbtn_welded.setIconSize(QtCore.QSize(200, 200))
        self.rdbtn_welded.setObjectName("rdbtn_welded")
        self.horizontalLayout_2.addWidget(self.rdbtn_welded)
        spacerItem21 = QtWidgets.QSpacerItem(150, 818, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem21)
        self.Tension_Start = QtWidgets.QPushButton(self.Tension)
        self.Tension_Start.setGeometry(QtCore.QRect(470, 680, 221, 25))
...
"}")
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(11, 11, 2, 2))
